                ...
                <div class="card h-100">
                  <div class="card-body p-2">
                    ...
                    <div class="d-flex justify-content-between">
                      <small class="text-danger">${lastPlay.awaySegmentPoints[1] || 0}</small>
                      <small class="text-success">${lastPlay.homeSegmentPoints[1] || 0}</small>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-3">
                <div class="card h-100">
                  <div class="card-body p-2">
                    ...
                    <div class="d-flex justify-content-between">
                      <small class="text-danger">${lastPlay.awaySegmentPoints[2] || 0}</small>
                      <small class="text-success">${lastPlay.homeSegmentPoints[2] || 0}</small>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-3">
                <div class="card h-100">
                  <div class="card-body p-2">
                    ...
                    <div class="d-flex justify-content-between">
                      <small class="text-danger">${lastPlay.awaySegmentPoints[3] || 0}</small>
                      <small class="text-success">${lastPlay.homeSegmentPoints[3] || 0}</small>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-3">
                <div class="card h-100">
                  <div class="card-body p-2">
                    ...
                    <div class="d-flex justify-content-between">
                      <small class="text-danger">${lastPlay.awaySegmentPoints[4] || 0}</small>
                      <small class="text-success">${lastPlay.homeSegmentPoints[4] || 0}</small>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="col-md-3">
                <div class="card h-100">
                  <div class="card-body p-2">
                    ...
                    <div class="d-flex justify-content-between">
                      <small class="text-danger">${lastPlay.awaySegmentPoints[5] || 0}</small>
                      <small class="text-success">${lastPlay.homeSegmentPoints[5] || 0}</small>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-3">
                <div class="card h-100">
                  <div class="card-body p-2">
                    ...
                    <div class="d-flex justify-content-between">
                      <small class="text-danger">${lastPlay.awaySegmentPoints[6] || 0}</small>
                      <small class="text-success">${lastPlay.homeSegmentPoints[6] || 0}</small>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-3">
                <div class="card h-100">
                  <div class="card-body p-2">
                    ...
                    <div class="d-flex justify-content-between">
                      <small class="text-danger">${lastPlay.awaySegmentPoints[7] || 0}</small>
                      <small class="text-success">${lastPlay.homeSegmentPoints[7] || 0}</small>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-md-3">
                <div class="card h-100">
                  <div class="card-body p-2">
                    ...
                    <div class="d-flex justify-content-between">
                      <small class="text-danger">${lastPlay.awaySegmentPoints[8] || 0}</small>
                      <small class="text-success">${lastPlay.homeSegmentPoints[8] || 0}</small>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-md-4">
            ...
            <div class="mt-3 mb-2">
              ...
              <div class="position-relative" style="height: 20px;">
                ...
                <div class="position-absolute top-0 end-50 w-50">
                  <div class="progress" style="height: 20px; transform: rotate(180deg);">
                    <div class="bg-danger" role="progressbar" 
              ...
              <div class="d-flex justify-content-between mt-1">
                <small class="text-danger">${lastPlay.awaySegmentsPoints}</small>
                <small class="text-success">${lastPlay.homeSegmentsPoints}</small>
              </div>
            </div>
